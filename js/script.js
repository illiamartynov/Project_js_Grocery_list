...
addItem = () => {
    ...
    const li_item = `<li class = ${imageObject.li_contains}>- ${user_insert} <div class = ${imageObject.div_class}><img class = ${imageObject.class_bin} src = ${imageObject.src_bin}> <img class = ${imageObject.class_bin} src = ${imageObject.money_src}> <img class = ${imageObject.class_bin} src = ${imageObject.bag_src}></div></li>`
